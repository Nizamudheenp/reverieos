...
import { Brain, Sparkles, Moon, Eye } from "lucide-react";
        ...
        >
          ...
          >
            ...
            >
              ...
              <GoogleIcon className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 relative z-10" />
          ...
          >
            © {new Date().getFullYear()} ReverieOS — Where dreams reveal their secrets.
          </motion.p>
        </motion.div>
      )}
    </div>
